...
export const metadata: Metadata = {
  title: "Luxe Haven - Luxury Hotel & Premium Accommodations",  description: "Experience award-winning luxury hospitality at Luxe Haven. Premium rooms, world-class amenities, and exceptional service in the heart of the city.",  keywords: "luxury hotel, premium accommodations, 5-star hotel, hospitality, resort, booking",  metadataBase: new URL("https://luxehaven.com"),
  alternates: {
    canonical: "https://luxehaven.com"},
  openGraph: {
    title: "Luxe Haven - Your Perfect Escape Awaits",    description: "Discover luxury hospitality with premium rooms, award-winning service, and world-class amenities.",    url: "https://luxehaven.com",    siteName: "Luxe Haven",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/young-beautiful-woman-sitting-bed-hotel-stylish-evening-dress-sensual-mood-talking-phone-smiling-flirty-looking-sexy_285396-6176.jpg",        alt: "luxury hotel suite elegant interior"},
    ],
    type: "website"},
  twitter: {
    card: "summary_large_image",    title: "Luxe Haven - Luxury Hotel & Premium Accommodations",    description: "Experience award-winning luxury hospitality at Luxe Haven.",    images: ["http://img.b2bpic.net/free-photo/young-beautiful-woman-sitting-bed-hotel-stylish-evening-dress-sensual-mood-talking-phone-smiling-flirty-looking-sexy_285396-6176.jpg"],
  },
  robots: {
    index: true,
    follow: true,
